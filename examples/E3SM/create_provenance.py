...
def get_desc_sim_schema():
    ...
    fosd.write("field,dataType,constraint\n")
...
def get_simulation_input_schema():
    ...
    fosi.write("field,dataType,constraint\n")
...
def get_simulation_timinglogs_schema():
    ...
    foso.write("field,dataType,constraint\n")
